...
After you create the services,set `NEXT_PUBLIC_SOCKET_URL` on the frontend service to the backend's public URL, then set `SOCKET_CORS_ORIGIN` on the backend to the frontend URL.
